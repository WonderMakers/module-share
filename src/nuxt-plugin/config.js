export default {
  socials: {
    ...
    tg: (url, title, description, image) => `https://t.me/share/url?url=${url}&text=${title}%20${description}`,
    tgScheme: (url, title, description, image) => `tg://share?url=${url}&text=${title}%20${description}`,
